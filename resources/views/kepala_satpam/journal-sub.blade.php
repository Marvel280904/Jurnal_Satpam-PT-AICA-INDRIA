...
<div id="top-anchor" class="journal-container">
    ...
    <form id="jurnalForm" enctype="multipart/form-data">
        ...
        <div class="form-group-row">
            ...
            <div>
                <label>Shift Berikutnya <i class="bi bi-asterisk"></i> </label>
        ...
        @foreach ($itemsYesNo as $key => $label)
            <div class="form-group">
                ...
                <div class="radio-group">
                    <label><input type="radio" name="is_{{ $key }}" value="1" required> Ya</label>
                    <label><input type="radio" name="is_{{ $key }}" value="0" required> Tidak</label>
                </div>
